...
<template>
  ...
  <AppLayout :breadcrumbs="breadcrumbs">
    <div
      class="max-w-md mx-auto mt-10 p-6 bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700">
      ...
      <form @submit.prevent="submitPayment" class="space-y-5">
        ...
        <div>
          ...
          <input v-model="form.description" type="text" placeholder="Payment description"
